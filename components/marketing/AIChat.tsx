...
export default function AIChat() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen(o => !o)}
        className={`fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#003087] text-white rounded-full shadow-lg hover:bg-[#002070] transition-all hover:scale-110 flex items-center justify-center`}
