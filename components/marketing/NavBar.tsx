...
export function NavBar() {
  ...
  const navLinks = {
    ...
    TSI: [
      ...
      { href: '/news?brand=tsi', label: 'News' },
      { href: '/contact?brand=tsi', label: 'Contact' },
    ],
    SBL: [
      { href: '/sbl/fleet', label: 'Fleet' },
      { href: '/ccw/compliance', label: 'Capabilities' },
      { href: '/news?brand=sbl', label: 'News' },
      { href: '/sbl/resources', label: 'Resources' },
      { href: '/careers?brand=sbl', label: 'Careers' },
      { href: '/contact?brand=sbl', label: 'Contact' },
    ],
    ZEPS: [
      { href: '/zeps', label: 'Overview' },
      { href: '/zeps/fta-grants', label: 'FTA Grants' },
      { href: '/ccw/compliance', label: 'Capabilities' },
      { href: '/news?brand=zeps', label: 'News' },
      { href: '/contact?brand=zeps', label: 'Contact' },
    ],
  } as const
      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a
            ...
            className="flex items-center gap-1.5 text-sm font-semibold text-gray-700 hover:text-gray-900 transition-colors border-l border-gray-200 pl-4 ml-2 whitespace-nowrap"
          >
